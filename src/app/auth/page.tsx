...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen flex justify-center bg-white">
      <div className="w-full max-w-sm flex flex-col px-4">
        ...
        <button
          onClick={handleLogin}
          className="w-full bg-blue-500 text-white font-semibold text-[15px] rounded-full py-3 hover:bg-blue-600 transition mb-8"
        >
          Login
        </button>
      </div>
